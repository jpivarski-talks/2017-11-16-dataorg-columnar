...
\vspace{0.5 cm}
Whether it's a ROOT file or a Parquet file, the file structure glues a set of columns together to be downloaded, replicated, versioned, or migrated to colder storage {\it as a unit.}
\end{frame}
...
\vspace{0.2 cm}
For instance, version~1 has incorrect jet energy corrections; version~2 is just like it but with different jet energies. Versions~1 and 2 should point to the same data and share storage for all other columns. (Currently, users share recipes!)
